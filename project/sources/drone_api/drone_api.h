...
#define OUT_OF_BOUNDS_POSITION 2
#define OCCUPIED_POSITION_WALL 3
#define OCCUPIED_POSITION_DRONE 4
#define DRONE_NOT_SPAWNED 5
#define DRONE_ALREADY_SPAWNED 6
#define DRONE_IS_LANDED 7
#define ONE_CELL_AT_A_TIME 8
#define LAND_ONLY_AT_Z0 9
